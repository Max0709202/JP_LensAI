...
class EmergencyPhrasesScreen extends StatelessWidget {
  ...
  static final phrases = <Phrase>[
    ...
    _phrase('I am lost', '道に迷いました。', 'Michi ni mayoimashita.',
        'I am lost.'),
    _phrase('I have an allergy', 'アレルギーがあります。',
    ...
    _phrase('I missed the last train', '終電を逃しました。',
        'Shuuden o nogashimashita.', 'I missed the last train.'),
    ...
    _phrase(
        'Can you help me?', '助けてもらえますか？', 'Tasukete moraemasu ka?', 'Can you help me?'),
    _phrase('I need a taxi', 'タクシーが必要です。', 'Takushii ga hitsuyou desu.',
        'I need a taxi.'),
    _phrase('I lost my wallet', '財布をなくしました。',
        'Saifu o nakushimashita.', 'I lost my wallet.'),
    _phrase('I need an English speaker', '英語を話せる人が必要です。',
        'Eigo o hanaseru hito ga hitsuyou desu.',
        'I need someone who speaks English.'),
    _phrase('Please speak slowly', 'ゆっくり話してください。',
